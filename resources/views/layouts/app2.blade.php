...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="{{ url('/tables') }}"><i class="icon icon-th"></i> <span>Tables</span></a></li>
    <li><a href="{{ url('/productajaxCRUD') }}"><i class="icon icon-th"></i> <span>Ajax Tables</span></a></li>
    <li><a href="{{ url('/peminjaman') }}"><i class="icon icon-th-list"></i> <span>Peminjaman</span></a></li>
  </ul>
</div>
<!--sidebar-menu-->
<!--main-container-part-->
